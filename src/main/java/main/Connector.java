...
public class Connector {
    ...
    public static final String URL = "jdbc:mysql://localhost:3306/SingleTask?autoreconnect=true&useUnicode=yes&characterEncoding=UTF-8";
    public static final String USER = "SingleTaskUser";
    public static final String PASSWORD = "singletask";
